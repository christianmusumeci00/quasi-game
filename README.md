...
Chi crea la sfida condivide un link che contiene gli identificativi delle dieci prove e un seed casuale. I dati sono nel frammento `#challenge`: GitHub Pages riceve sempre la root esistente e non mostra pagine 404. Il creatore resta nella sala d’attesa senza scadenza, vede i partecipanti che entrano e può indicarsi come pronto. Quando ci sono almeno due giocatori e tutti i presenti sono pronti, Supabase Realtime avvia immediatamente la stessa partita per tutti.

Lo stesso link può essere aperto da più partecipanti: Presence mostra chi è online e chi è pronto. Avanzamento e risultati vengono sincronizzati tramite Presence, eventi realtime e un riepilogo temporaneo della stanza, così anche chi termina per ultimo recupera i punteggi già inviati dagli amici. **Gioca ancora** invia una richiesta di rivincita a tutto il gruppo e la avvia senza generare né inviare un altro link. La modalità Sfida live richiede Supabase; Giocatore singolo e Allenamento restano disponibili anche offline.
